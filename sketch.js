...
function preload(){
  ...
  /*
  gameOverSound = loadMusic("gameover.mp3")
  knifeSwooshSound = loadMusic("knifeSwoosh.mp3")
  */
   /*
  ...
  */
  /*
  gameOverSound = addSong("gameover.mp3")
  knifeSwooshSound = addSong("knifeSwoosh.mp3")
  */
   /*
  gameOverSound = loadSong("gameover")
  knifeSwooshSound = loadSong("knifeSwoosh")
  */
}
...
function draw() {
  ...
  if(gameState===PLAY){
    ...
    if(fruitGroup.isTouching(knife)){
      ...
      // knifeSwooshSound.playSound();
      // knifeSwooshSound.play();
      // knifeSwooshSound.play;
      // knifeSwooshSound.playSong();
      score=score+2;
    }
    else
    {
